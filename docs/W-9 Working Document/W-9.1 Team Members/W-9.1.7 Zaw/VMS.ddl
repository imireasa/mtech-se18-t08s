ALTER TABLE `TB_USER_DETAIL` DROP FOREIGN KEY `FKTB_USER_DE115797`;
ALTER TABLE `TB_PROJECT_TASK` DROP FOREIGN KEY `FKTB_PROJECT627018`;
ALTER TABLE `TB_PROJECT_FEEDBACK` DROP FOREIGN KEY `FKTB_PROJECT303640`;
ALTER TABLE `TB_PROJECT_MEMBER` DROP FOREIGN KEY `FKTB_PROJECT662350`;
ALTER TABLE `TB_PROJECT_TASK_MEMBER` DROP FOREIGN KEY `FKTB_PROJECT235243`;
ALTER TABLE `TB_PROJECT_INTREST` DROP FOREIGN KEY `FKTB_PROJECT169016`;
ALTER TABLE `TB_CODE` DROP FOREIGN KEY `FKTB_CODE317331`;
ALTER TABLE `TB_PROJECT` DROP FOREIGN KEY `FKTB_PROJECT334276`;
ALTER TABLE `TB_PROJECT_EXPERENCE` DROP FOREIGN KEY `FKTB_PROJECT154073`;
ALTER TABLE `TB_PROJECT_PROPOSAL_DOCUMENT` DROP FOREIGN KEY `FKTB_PROJECT324928`;
ALTER TABLE `TB_PROJECT_PROPOSAL_DOCUMENT` DROP FOREIGN KEY `FKTB_PROJECT47632`;
DROP TABLE IF EXISTS `TB_EVENT_ATTENDEE`;
...
DROP TABLE IF EXISTS `TB_PROJECT_INTREST`;
DROP TABLE IF EXISTS `TB_EVENT_CAL`;
...
DROP TABLE IF EXISTS `TB_PROJECT_EXPERENCE`;
DROP TABLE IF EXISTS `TB_PROJECT_PROPOSAL_DOCUMENT`;
CREATE TABLE `TB_EVENT_ATTENDEE` (
  `EVNT_ATTD_ID` bigint(19) NOT NULL AUTO_INCREMENT, 
  `EVNT_ID`      bigint(19) NOT NULL, 
  `ATTD_ID`      bigint(19) NOT NULL, 
  `TX_ID`        bigint(19) NOT NULL, 
  PRIMARY KEY (`EVNT_ATTD_ID`));
CREATE TABLE `TB_PROJECT_MEMBER` (
  ...
  `ACT_IND`      tinyint(1) DEFAULT 1 NOT NULL, 
...
CREATE TABLE `TB_DOCUMENT` (
  ...
  `FLE`         blob NOT NULL, 
  `DESC`        varchar(255), 
  `DEL_IND`     tinyint(1) DEFAULT 0 NOT NULL, 
  `CREATED_BY`  varchar(20) NOT NULL, 
  `CREATED_DTE` datetime NOT NULL, 
  `UPD_BY`      varchar(20) NOT NULL, 
  `UPD_DTE`     datetime NOT NULL, 
...
CREATE TABLE `TB_USER` (
  ...
  `USR_LOGIN_ID` varchar(20) NOT NULL UNIQUE, 
  ...
  `POST_CD`      int(6), 
  `CTRY_CD`      bigint(19), 
  `ACT_IND`      tinyint(1) DEFAULT 0 NOT NULL, 
...
CREATE TABLE `TB_USER_DETAIL` (
  ...
  `USR_ID`       bigint(19) NOT NULL UNIQUE, 
  `INTRST`       varchar(255), 
  `SKILL_SET`    varchar(255), 
  `QUAL_ATT`     varchar(255), 
  `JOB_TITLE_CD` bigint(19), 
  `SALARY`       decimal(14, 2), 
...
CREATE TABLE `TB_PROJECT_FEEDBACK` (
  ...
  `APPR_BY`     varchar(20), 
  `APPR_DTE`    datetime, 
  `STS_CD`      bigint(19) DEFAULT 0 NOT NULL, 
  `CREATED_BY`  varchar(20) NOT NULL, 
  `CREATED_DTE` datetime NOT NULL, 
  `UPD_BY`      bigint(20) NOT NULL, 
  `UPD_DTE`     datetime NOT NULL, 
...
CREATE TABLE `TB_EVENT_CAL` (
  `EVNT_ID`    bigint(19) NOT NULL AUTO_INCREMENT, 
  `EVNT_NME`   varchar(100) NOT NULL, 
  `EVNT_TYPE`  bigint(19), 
...
CREATE TABLE `TB_CODE_CATEGORY` (
  ...
  `DESC`   varchar(255), 
  PRIMARY KEY (`CAT_ID`));
CREATE TABLE `TB_PROJECT_EXPERENCE` (
