...
<body>
	...
	<div id="breadcrumb">
	<a href="#">Home</a> / <a href="#">Register Volunteer Account</a></div>
    <h2> Register Volunteer Account</h2>
	<div class="query">
	  ...
	  <table width="548" height="105" >
        ...
        <tr>
         ...
         <tr>
	      ...
	      <td><input type="text" name="txtField_confirmPassword" id="txtField_confirmPassword"></td>
        </tr>
         <tr>
        ...
        <tr>
	      <td><input name="btn_Update" type="submit" value="Create"></td>
          <td><input name="btn_clear" type="submit" value="Clear"></td>
	      <td>&nbsp;</td>
        </tr>
      </table>
   	 </form>
