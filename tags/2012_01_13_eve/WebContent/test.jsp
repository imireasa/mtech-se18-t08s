...
<title>Example: Website Left Nav Using Animation With Submenus
	Built From Markup (YUI Library)</title>
...
<body class="yui-skin-sam" id="yahoo-com">
	...
	<div id="doc" class="yui-t1">
		<div id="hd">
			...
			<h1>Example: Website Left Nav Using Animation With Submenus
				Built From Markup (YUI Library)</h1>
		...
		<div id="bd">
			...
			<div id="yui-main">
				<div class="yui-b">
					...
					<p>
						<strong>NOTE:</strong> <em>This example demonstrates how to
							add animation effects to a menu with submenus built using
							existing markup.</em>
					</p>
					...
					<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
						...
						tortor eget odio. Pellentesque orci arcu, eleifend at, iaculis sit
						amet, posuere eu, lorem. Aliquam erat volutpat. Phasellus
					...
					<div class="bd">
						<ul class="first-of-type">
							<li class="yuimenuitem first-of-type"><a
								class="yuimenuitemlabel" href="#communication">Communication</a>
								...
								<div id="communication" class="yuimenu">
									<div class="bd">
										<ul>
											...
											<li class="yuimenuitem"><a class="yuimenuitemlabel"
												href="http://promo.yahoo.com/broadband/">Internet Access</a>
											</li>
											<li class="yuimenuitem"><a class="yuimenuitemlabel"
												href="#">PIM</a>
											...
											<li class="yuimenuitem"><a class="yuimenuitemlabel"
												href="http://www.flickr.com">Flickr Photo Sharing</a></li>
