...
CREATE TABLE TB_ROLE (ROLE_ID BIGINT(19) NOT NULL AUTO_INCREMENT, ROLE_CD BIGINT(20) NOT NULL, CREATED_BY VARCHAR(20) NOT NULL, CREATED_DTE DATETIME NOT NULL, UPD_BY VARCHAR(20) NOT NULL, UPD_DTE DATETIME NOT NULL, VERSION INT(10) NOT NULL, PRIMARY KEY (ROLE_ID));
...
CREATE TABLE TB_PROJECT_MEMBER (PRJ_MBR_ID BIGINT(19) NOT NULL AUTO_INCREMENT, PRJ_ID BIGINT(19) NOT NULL, USR_LOGIN_ID VARCHAR(20) NOT NULL, ROLE_CD BIGINT(19) NOT NULL, ACT_IND TINYINT(1) DEFAULT 1 NOT NULL, CREATED_BY VARCHAR(20) NOT NULL, CREATED_DTE DATETIME NOT NULL, UPD_BY VARCHAR(20) NOT NULL, UPD_DTE DATETIME NOT NULL, VERSION INT(10) NOT NULL, PRIMARY KEY (PRJ_MBR_ID));
