...
public class ProjectManagementServiceImpl implements ProjectManagementService {
        ...
        public ProjectVo getProjectVoByLoginUserAccessRight(Long projectId) {
                ...
                for (ProjectMemberDto projectMemberDto : projectMemberList) {
                        ...
                        hQL = "from ProjectMemberDto where prjId.prjId=" + projectId + " and actInd=1";
                        ...
                        for (ProjectMemberDto _projectMemberDto : _projectMemberList) {
                                ...
                                List<UserDto> userList = manager.find("from UserDto where usrLoginId='" + _projectMemberDto.getUsrLoginId() + "'");
        ...
        @Override
        public List<ProjectInterestVo> getProjectIntrestVoByLoginUserAccessRight(Long projectId) {
                String userLogInId = UserUtil.getUserSessionInfoVo().getUserID();
                ...
                for (ProjectInterestDto projectInterest : projectInterestList) {
                        ...
                        List<UserDto> userList = manager.find("from UserDto where usrLoginId='" + projectInterest.getReqBy() + "'");
                        if (userList != null && !userList.isEmpty()) {
        ...
        public void deleteProjectMember(String projectMemberId) throws Exception {
                try {
                        ...
                        ProjectMemberDto dto = (ProjectMemberDto) manager.get(ProjectMemberDto.class, _projectMemberId);
                        dto.setActInd(false);
                        manager.save(dto);

                } catch (Exception ex) {
                        logger.debug("Delete Project Member Fail.", ex);
                        throw new ApplicationException(Messages.getString("message.common.error.remove"));
                }
        }
