...
public class ProjectDto extends BaseVersionDto implements Serializable {
        ...
        public ProjectDto(Long prjId, String nme, String desc, Date strDte, Date endDte, long ctryCd, String loc, long stsCd, String createdBy, Date createdDte, String updBy, Date updDte, int version) {
                this.prjId = prjId;
                this.nme = nme;
                this.desc = desc;
                this.strDte = strDte;
        ...
        public void setProjectInterestList(List<ProjectInterestDto> projectInterestList) {
        ...
        public void setProjectFeedbackList(List<ProjectFeedbackDto> projectFeedbackList) {
