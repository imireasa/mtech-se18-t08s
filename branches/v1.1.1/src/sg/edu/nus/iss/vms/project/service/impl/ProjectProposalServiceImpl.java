...
public class ProjectProposalServiceImpl implements ProjectProposalService {
	...
	public void createProjectProposal(ProjectProposalVo projectProposalVo,
			List<ProjectProposalDocumentVo> projectProposalDocumentVos) {
	...
	private List<DocumentDto> createAndGetDocumentDtoList(
			List<ProjectProposalDocumentVo> projectProposalDocumentVos) {
		...
		String loginId = UserUtil.getUserSessionInfoVo().getUserID();
		CodeLookupVo codeVo = CodeLookupUtil.getCodeByCategoryAndCodeValue(
				VMSConstants.REFERENCE_TYPE_CATEGORY,
				VMSConstants.REFERENCE_TYPE_CATEGORY_PROPOSAL);
