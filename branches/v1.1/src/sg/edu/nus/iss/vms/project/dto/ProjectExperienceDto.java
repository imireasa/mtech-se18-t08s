 ...
 */
@Entity
@Table(name = "tb_project_experience")
@NamedQueries({
    @NamedQuery(name = "ProjectExperienceDto.findAll", query = "SELECT t FROM ProjectExperienceDto t")})
public class ProjectExperienceDto implements Serializable {
    ...
    public ProjectExperienceDto(Long prjExpId) {
        this.prjExpId = prjExpId;
    }

    public ProjectExperienceDto(Long prjExpId, String cont, String createdBy, String createdDte) {
        this.prjExpId = prjExpId;
        this.cont = cont;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProjectExperienceDto)) {
            return false;
        }
        ProjectExperienceDto other = (ProjectExperienceDto) object;
    ...
    public String toString() {
        return "sg.edu.nus.iss.vms.common.dto.ProjectExperienceDto[ prjExpId=" + prjExpId + " ]";
    }
