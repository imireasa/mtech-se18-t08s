...
<script type="text/javascript">
	function getMemberData() {
		return;
		document.forms["form"].action = "<%=request.getContextPath()%>/admin/generatecertificate/generateCertificate.html"
...
<body>
	...
	<div class="query">
		<form id="form" name="form" method="post"
			action="<%=request.getContextPath()%>/admin/generatecertificate/generateCertificatePdf.html">
			<table width="545" >
				<tr>
