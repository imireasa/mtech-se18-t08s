...
<body>
    ...
    <div id="breadcrumb">
        <a href="<%=request.getContextPath()%>/common/welcome.html"><fmt:message key="message.common.home.label"/></a> / <a href="listProjects.html"><fmt:message key="message.projectManagement.projectManagement.label"/></a> / <fmt:message key="message.projectManagement.createProject.label"/>
    </div>
    <div class="query">
        ...
        <form:form name="createProject" method="post"
            ...
            <table class="query-table">
                ...
                <tr>
                    ...
                    <td><fmt:message key="message.common.symbol.afterLabel.label" /></td>
                    <td align="left"><label for="textarea"></label>
                        <form:textarea path="loc" cols="45" rows="4" cssClass="validate[required,maxSize[255]]"></form:textarea>
                ...
                <tr>
                    <td colspan="2"></td>
                    <td><input type="submit" name="createButton" id="createButton" value="<fmt:message key="message.common.create.button"/>"></td>
                </tr>
            </table>
        </form:form>
    </div>
